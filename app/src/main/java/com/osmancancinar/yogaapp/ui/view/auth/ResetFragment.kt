...
import com.osmancancinar.yogaapp.ui.viewModel.auth.ResetVM
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class ResetFragment : Fragment(), FirebaseListener {
    ...
    private fun goBackToGreet() {
        //Fix This - > navigate to greet fragment. = //requireView()
